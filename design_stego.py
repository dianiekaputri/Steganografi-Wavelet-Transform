...
"gridline-color: rgb(238, 238, 236);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.getFileNameInsert.setText(_translate("MainWindow", "Path ke Gambar"))
        self.getKeyPathInsert.setText(_translate("MainWindow", "Path ke Kunci"))
        self.getFileNameExtract.setText(_translate("MainWindow", "Path ke Gambar"))
        self.getKeyPathExtract.setText(_translate("MainWindow", "Path ke Kunci"))
        self.Insert.setText(_translate("MainWindow", "Masukkan Informasi"))
        self.Extract.setText(_translate("MainWindow", "Ekstraksi Informasi"))
        self.label_2.setText(_translate("MainWindow", "Format File Keluaran"))
        self.label_3.setText(_translate("MainWindow", "Hasil Implementasi:"))
        self.label_4.setText(_translate("MainWindow", "Penyisipan Data"))
        self.label_5.setText(_translate("MainWindow", "Ekstraksi Data"))
        self.label_6.setText(_translate("MainWindow", "Tingkat Dekomposisi"))
